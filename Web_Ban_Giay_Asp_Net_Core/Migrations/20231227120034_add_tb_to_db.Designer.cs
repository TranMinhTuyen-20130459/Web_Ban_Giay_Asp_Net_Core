...
namespace Web_Ban_Giay_Asp_Net_Core.Migrations
{
    ...
    [Migration("20231227120034_add_tb_to_db")]
    partial class add_tb_to_db
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Ban_Giay_Asp_Net_Core.Entities.MethodPayment", b =>
                {
                    b.Property<int>("id_method_payment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("name_method")
                        .HasColumnType("longtext");

                    b.HasKey("id_method_payment");

                    b.ToTable("Method_Payments");
                });
            ...
            modelBuilder.Entity("Web_Ban_Giay_Asp_Net_Core.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("id_status_payment")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("id_method_payment");

                    b.HasIndex("id_status_order");

                    b.HasIndex("id_status_payment");
            ...
            modelBuilder.Entity("Web_Ban_Giay_Asp_Net_Core.Entities.StatusOrder", b =>
                {
                    b.Property<int>("id_status_order")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("id_status_order");

                    b.ToTable("Status_Orders");
                });

            modelBuilder.Entity("Web_Ban_Giay_Asp_Net_Core.Entities.StatusPayment", b =>
                {
                    b.Property<int>("id_status_payment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("id_status_payment");

                    b.ToTable("Status_Payments");
                });
            ...
            modelBuilder.Entity("Web_Ban_Giay_Asp_Net_Core.Entities.Order", b =>
                {
                    b.HasOne("Web_Ban_Giay_Asp_Net_Core.Entities.MethodPayment", "method_payment")
                        .WithMany("list_order")
                        .HasForeignKey("id_method_payment")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_Ban_Giay_Asp_Net_Core.Entities.StatusOrder", "status_order")
                        .WithMany("list_order")
                        .HasForeignKey("id_status_order")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_Ban_Giay_Asp_Net_Core.Entities.StatusPayment", "status_payment")
                        .WithMany("list_order")
                        .HasForeignKey("id_status_payment")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("method_payment");

                    b.Navigation("status_order");

                    b.Navigation("status_payment");
                });
